...
export default function SupplyChain() {
  ...
  return (
    <section className="py-20 bg-light-cream" id="supply" ref={ref}>
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="rounded-[40px] overflow-hidden shadow-2xl shadow-black/5">
              <img 
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-extrabold text-dark-green mb-6">التكامل مع سلسلة الإمداد</h2>
